...
import { regionBucketOf, groupOf, type RegionBucket, type SortKey, type UseGroup } from '@/lib/buildingHelpers';
...
export default function Buildings() {
  ...
  const items = useMemo(() => {
    ...
    if (useGroup) arr = arr.filter((b) => groupOf(b.use) === useGroup);
    if (q) {
