...
function SelectedPanel({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden pb-10">
      ...
      <div className="grid h-[210px] shrink-0 grid-cols-1 gap-4 lg:grid-cols-2 lg:items-stretch">
        {/* 비품 카테고리 TOP 10 */}
